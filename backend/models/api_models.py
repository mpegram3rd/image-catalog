...
class SearchResult(BaseModel):
    ...
    description: Annotated[str, Field(description="A detailed description of the image that can be used to describe it "
    ...
    distance: Annotated[float, Field(description="The calculated distance in vector space between the search criteria "
...
class SearchResultsMcp(BaseModel):
    ...
    description: Annotated[str, Field(description="A detailed description of the image that can be used to describe "
